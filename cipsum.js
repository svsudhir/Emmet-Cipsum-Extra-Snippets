/**
 * "Corporate ipsum" text generator. 
 * By Sudharshan S Veeravalli.
 * Matches <code>cipsum(num)?</code> or 
 * <code>clorem(num)?</code> abbreviation.
 * This code is based on Django's contribution: 
 * https://code.djangoproject.com/browser/django/trunk/django/contrib/webdesign/lorem_ipsum.py
 * <br><br>
 * Examples to test:<br>
 * <code>cipsum</code> – generates 30 words text.<br>
 * <code>cipsum*6</code> – generates 6 paragraphs (autowrapped with &lt;p&gt; element) of text.<br>
 * <code>ol>cipsum10*5</code> — generates ordered list with 5 list items (autowrapped with &lt;li&gt; tag)
 * with text of 10 words on each line<br>
 * <code>span*3>cipsum20</code> – generates 3 paragraphs of 20-words text, each wrapped with &lt;span&gt; element .
 ...
 */
emmet.define('cipsum', function(require, _) {
	var langs = {
		en: {
			common: [''],
	...
	require('abbreviationParser').addPreprocessor(function(tree) {
		var re = /^(?:clorem|cipsum)([a-z]{2})?(\d*)$/i, match;
		...
		tree.findAll(function(node) {
			if (node._name && (match = node._name.match(re))) {
				...
				node.data('paste', function(i) {
					return paragraph(lang, wordCound, 0);
				});
			}
		});
	});
	...
	/**
	 * Generate a paragraph of "Corporate ipsum" text
	 * @param {Number} wordCount Words count in paragraph
	 * @param {Boolean} startWithCommon Should paragraph start with common 
	 * "Corporate ipsum" sentence.
	 * @returns {String}
	 */
	...
	return {
		/**
		 * Adds new language words for Corporate ipsum generator
